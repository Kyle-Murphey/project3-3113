...
static int inode_compare_to(const void *d1, const void *d2)
{
  ...
  // TODO: complete implementation
  if ((e1->inode_reference < e2->inode_reference) || (e1->inode_reference != UNALLOCATED_INODE && e2->inode_reference == UNALLOCATED_INODE))
  {
    return -1;
  }
  else if ((e1->inode_reference == e2->inode_reference) || (e1->inode_reference == UNALLOCATED_INODE && e2->inode_reference == UNALLOCATED_INODE))
  {
    return 0;
  }
  else if ((e1->inode_reference > e2->inode_reference) || (e1->inode_reference == UNALLOCATED_INODE && e2->inode_reference != UNALLOCATED_INODE))
